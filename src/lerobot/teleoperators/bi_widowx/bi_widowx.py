...
from .config_bi_widowx import BiWidowXConfig

logger = logging.getLogger(__name__)


class BiWidowX(Teleoperator):
    """
    [Bimanual WidowX Arms] designed by Lennart
    This bimanual leader arm can also be easily adapted to use WidowX arms, just replace the WidowX class with WidowX and WidowXConfig with WidowXConfig.
    """

    config_class = BiWidowXConfig
    name = "bi_widowx"

    def __init__(self, config: BiWidowXConfig):
        ...
        left_arm_config = WidowXConfig(
            ...
            use_aloha2_gripper_servo=config.left_arm_use_aloha2_gripper_servo,
        )
        ...
        right_arm_config = WidowXConfig(
            ...
            use_aloha2_gripper_servo=config.right_arm_use_aloha2_gripper_servo,
        )
