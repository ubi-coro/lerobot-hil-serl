...
@dataclass
@EnvConfig.register_subclass("aloha_bimanual_lemgo_v2_left")
class AlohaBimanualEnvConfigLemgoV2Left(HilSerlRobotEnvConfig):
...
@dataclass
@DatasetRecordConfig.register_subclass("aloha_bimanual_lemgo_v2_left")
class AlohaBimanualDatasetConfigLemgoV2Left(DatasetRecordConfig):
