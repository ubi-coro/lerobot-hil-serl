...
class AlohaUnfoldingDatasetConfig(DatasetRecordConfig):
    repo_id: str = ("hoodie_unfolding_v3/hoodie_unfolding_act-191225_eval_2_080126")
    single_task: str = "Unfold the hoodie"
    root: str = "/media/nvme1/jstranghoener/lerobot/data/jannick-st/hoodie_unfolding_v3/hoodie_unfolding_act-191225_eval_2_080126"
    num_episodes: int = 50
