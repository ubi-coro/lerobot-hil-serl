...
class AlohaFoldingDatasetConfig(DatasetRecordConfig):
    repo_id: str = "hoodie_folding_v3/hoodie_folding_pi0-221225_eval_210126"
    single_task: str = "Fold the hoodie"
    root: str = "/media/nvme1/jstranghoener/lerobot/data/jannick-st/hoodie_folding_v3/hoodie_folding_pi0-221225_eval_210126"
    num_episodes: int = 50
