...
@dataclass
@EnvConfig.register_subclass("aloha_bimanual_lemgo_v2_right")
class AlohaBimanualEnvConfigLemgoV2Right(HilSerlRobotEnvConfig):
...
@dataclass
@DatasetRecordConfig.register_subclass("aloha_bimanual_lemgo_v2_right")
class AlohaBimanualDatasetConfigLemgoV2Right(DatasetRecordConfig):
