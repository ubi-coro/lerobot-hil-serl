...
class RTDEControlInterface:
    """
    A fake RTDEControlInterface that simulates sending commands to a UR.
    ...
    def initPeriod(self):
        """
        In real UR, this returns a timestamp token for synchronization.
    ...
    def waitPeriod(self, t0):
        """
        In real UR, blocks until the next RTDE tick.  Here, we sleep
    ...
    def servoL(self, pose, vel, acc, dt, lookahead_time, gain):
        """
        In real UR, this commands a single Cartesian pose at the next tick.
    ...
    def speedL(self, speed6, acc, dt):
        """
        In real UR, this commands a Cartesian velocity for `dt` seconds.
    ...
    def forceMode(self, selection_vector, wrench, type=None, limits=None, mask=None):
        """
        In real UR, engage force control.  We record the requested wrench so
    ...
    def stopScript(self):
        """
        In real UR, this would stop the RTDE script.  Here we do nothing.
        """
        pass

    def disconnect(self):
        """
        In real UR, this would close sockets.  Here we do nothing.
        """
        pass
